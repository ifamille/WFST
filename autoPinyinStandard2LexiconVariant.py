...
# original directory
directory = './PYSLs/'
intermediate_directory = './PYSs/'
# objective directory
destination_directory = './PYVLs/'
intermediate_destination_directory = './PYVs/'
# backup directory
...
if os.path.exists(directory):
    ...
    for file_or_folder in os.listdir(directory):
        ...
        intermediate_file_path = os.path.join(intermediate_destination_directory, name + '.pyv') 
...
print('---------------------------------------')
print('Executing ...\n')
print('Congratuation, all the files in directory <PYSLs> have been transformed into ' + destination_directory +' directory.')
print('---------------------------------------')
