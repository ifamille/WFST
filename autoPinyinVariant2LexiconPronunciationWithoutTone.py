...
# objective directory
destination_directory = './PYPLs/'
intermediate_destination_directory = './PYPs/'
# backup directory
...
if os.path.exists(directory):
    ...
    for file_or_folder in os.listdir(directory):
        ...
        intermediate_file_path = os.path.join(intermediate_destination_directory, name + '.pyp') 
        ...
        if os.path.isfile(file_path):
            ...
            # execute statement.
            os.system("python pinyinVariant2PronunciationWithoutTone.py " + file_or_folder)
