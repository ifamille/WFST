...
if os.path.exists(directory):
    ...
    for file_or_folder in os.listdir(directory):
        ...
        destination_file_path = os.path.join(destination_directory, name + '.sent') 
        # judge wheather one object in the directory is a file.
        if os.path.isfile(file_path):
            # execute statement.
            os.system("python pinyinWord2Sentence.py " + file_or_folder)
...
print('---------------------------------------')
print('Executing ...\n')
print('Congratuation, all the files in directory <PYWs> have been transformed into ' + destination_directory + ' directory.')
print('---------------------------------------')
